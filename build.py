...
<header class="hero">
  <div class="hero-inner">
    <div class="hero-tag">MentorPi &middot; Raspberry Pi 5 &middot; ROS 2 Humble &middot; LiDAR &middot; SLAM &middot; Nav2 &middot; Vision AI &middot; AI Agent</div>
    <h1>studyMentorPi</h1>
    <p class="hero-lede">
      ...
      색 인식·MediaPipe·YOLOv5·자율주행·군집 제어, <b>OpenClaw AI 에이전트</b>로 대화하며 로봇을 부리는 통합까지 이어진 뒤, <b>순찰 경비·QR 배송·미니 시티 자율주행·사람 추종 카트</b>(중급) 와 <b>프런티어 탐사·ICP+EKF 융합·강화학습 주행·시맨틱 자연어 내비</b>(고급) 8개 팀 프로젝트로 통합합니다. 모든 핵심 알고리즘은 브라우저의
  ...
  <div class="hero-art">
    <div class="hero-flow">
      ...
      <div class="flow-arrow">&darr;</div>
      <div class="flow-step"><b>5</b><span>AI 에이전트<small>OpenClaw · Skill · Telegram · 대화형 로봇 제어</small></span></div>
      <div class="flow-arrow">&darr;</div>
      <div class="flow-step hot"><b>6</b><span>팀 프로젝트<small>중급 4 · 고급 4 (탐사 · EKF · 강화학습 · 시맨틱)</small></span></div>
    </div>
...
<section class="facts">
  ...
  <div class="fact"><div class="fact-n">19</div><div class="fact-l">개 원본 강좌 → 5개 트랙 + 프로젝트 8개</div></div>
